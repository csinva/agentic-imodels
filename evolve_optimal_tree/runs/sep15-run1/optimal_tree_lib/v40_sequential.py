...
MULTICORE = False
DESCRIPTION = ('v40 run single-threaded (n_jobs=1): the compiled search of v28 plus the frame cache of v31 and the depth-3 stage switched off (v40); the parallel phase is never entered.  Recorded for the sequential leaderboard line (library use); exact, one core')
