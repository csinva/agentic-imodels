...
MULTICORE = True
DESCRIPTION = ('v49 run as an anytime method with the time limit capped at 2 ms per pair (the v46 anytime machinery: cap-scaled chunks, greedy seeds, bottom-up repair, budgeted pair stage) on top of the candidate-only pair stage and lazy workspaces.  Approximate by the cap only')
...
TIME_CAP = 0.002   # anytime rows: cap the time limit (seconds, 0 = none)
