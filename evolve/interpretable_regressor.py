...
model_shorthand_name = "AddGP_v49"
model_description = ("AddGP_v48 + above 1000 rows interactions beyond the first 48 are backfit on the joint model's "
                     "residual (up to 5 per feature, 16 per 1000 rows; per-pair resolution by marginal likelihood, "
                     "shared noise); n<=1000 identical to v48. Held-out: fps .0395->.0275, supercon .3343->.2872, "
                     "sarcos .1570->.1457, fifa .5829->.5523; 4000-row set neutral")
