...
class ElasticNetCleanRegressor(BaseEstimator, RegressorMixin):
...
ElasticNetCleanRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "ElasticNetClean_v1"
model_description = "ElasticNetCV on standardized X, report as linear formula in original scale"
model_defs = [(model_shorthand_name, ElasticNetCleanRegressor())]
