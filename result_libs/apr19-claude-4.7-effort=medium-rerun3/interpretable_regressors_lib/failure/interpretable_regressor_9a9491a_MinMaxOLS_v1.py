...
class MinMaxOLSRegressor(BaseEstimator, RegressorMixin):
...
MinMaxOLSRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "MinMaxOLS_v1"
model_description = "OLS after min-max scaling each feature to [0,1]; coefs back-transformed to original scale"
model_defs = [(model_shorthand_name, MinMaxOLSRegressor())]
