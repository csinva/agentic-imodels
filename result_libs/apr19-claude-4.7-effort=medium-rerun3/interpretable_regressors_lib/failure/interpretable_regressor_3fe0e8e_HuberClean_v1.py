...
class HuberCleanRegressor(BaseEstimator, RegressorMixin):
...
HuberCleanRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "HuberClean_v1"
model_description = "HuberRegressor (outlier-robust) on standardized X; back-transformed to original scale"
model_defs = [(model_shorthand_name, HuberCleanRegressor())]
