...
class TStatOLSRegressor(BaseEstimator, RegressorMixin):
...
TStatOLSRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "TStatOLS_v1"
model_description = "OLS with t-stat>1.96 feature selection, OLS refit"
model_defs = [(model_shorthand_name, TStatOLSRegressor())]
