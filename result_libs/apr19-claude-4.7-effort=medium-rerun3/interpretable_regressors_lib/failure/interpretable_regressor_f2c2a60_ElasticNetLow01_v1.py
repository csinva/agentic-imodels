...
class ElasticNetLow01Regressor(BaseEstimator, RegressorMixin):
...
ElasticNetLow01Regressor.__module__ = "interpretable_regressor"

model_shorthand_name = "ElasticNetLow01_v1"
model_description = "ElasticNetCV with low l1_ratio=0.05-0.5, mostly ridge regularization"
model_defs = [(model_shorthand_name, ElasticNetLow01Regressor())]
