...
class SparseOLSTop10Regressor(BaseEstimator, RegressorMixin):
    """Lasso-select up to 10 features, OLS refit."""
    ...
    def __str__(self):
        ...
        lines = [f"Sparse Linear Regression (top {len(self.support_)} features, LassoCV + OLS refit):",
...
SparseOLSTop10Regressor.__module__ = "interpretable_regressor"

model_shorthand_name = "SparseOLSTop10_v1"
model_description = "LassoCV selects ≤10 features, OLS refit"
model_defs = [(model_shorthand_name, SparseOLSTop10Regressor())]
