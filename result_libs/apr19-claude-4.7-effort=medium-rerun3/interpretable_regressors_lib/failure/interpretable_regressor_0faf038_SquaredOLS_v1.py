...
class SquaredOLSRegressor(BaseEstimator, RegressorMixin):
...
SquaredOLSRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "SquaredOLS_v1"
model_description = "Per-feature {x, x^2} basis, Lasso-select 12, OLS refit; quadratic GAM"
model_defs = [(model_shorthand_name, SquaredOLSRegressor())]
