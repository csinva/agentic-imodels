...
model_shorthand_name = "ThresholdOLS_5pct_v1"
model_description = "Full OLS, then prune features with |std-coef|<5% of max, refit OLS"
model_defs = [(model_shorthand_name, ThresholdOLSRegressor())]
