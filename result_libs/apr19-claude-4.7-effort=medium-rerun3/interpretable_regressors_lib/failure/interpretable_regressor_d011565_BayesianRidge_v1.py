...
class BayesianRidgeCleanRegressor(BaseEstimator, RegressorMixin):
...
BayesianRidgeCleanRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "BayesianRidge_v1"
model_description = "BayesianRidge linear regression with standardized features"
model_defs = [(model_shorthand_name, BayesianRidgeCleanRegressor())]
