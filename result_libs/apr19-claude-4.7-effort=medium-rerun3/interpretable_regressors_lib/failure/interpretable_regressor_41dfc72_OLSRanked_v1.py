...
class OLSRankedRegressor(BaseEstimator, RegressorMixin):
...
OLSRankedRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "OLSRanked_v1"
model_description = "Plain OLS with enhanced __str__ that ranks features by |coef*sd(x)|"
model_defs = [(model_shorthand_name, OLSRankedRegressor())]
