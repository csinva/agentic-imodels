...
class LassoCVCleanRegressor(BaseEstimator, RegressorMixin):
...
LassoCVCleanRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "LassoCVClean_v1"
model_description = "LassoCV with clean linear formula in original scale"
model_defs = [(model_shorthand_name, LassoCVCleanRegressor())]
