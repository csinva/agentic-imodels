...
class ARDLinearRegressor(BaseEstimator, RegressorMixin):
...
ARDLinearRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "ARDLinear_v1"
model_description = "ARD (automatic relevance determination) linear regression"
model_defs = [(model_shorthand_name, ARDLinearRegressor())]
