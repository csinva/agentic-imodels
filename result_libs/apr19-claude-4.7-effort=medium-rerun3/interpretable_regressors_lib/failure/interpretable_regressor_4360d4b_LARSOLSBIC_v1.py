...
class LARSOLSBICRegressor(BaseEstimator, RegressorMixin):
...
LARSOLSBICRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "LARSOLSBIC_v1"
model_description = "LassoLarsIC (BIC) feature selection, OLS refit"
model_defs = [(model_shorthand_name, LARSOLSBICRegressor())]
