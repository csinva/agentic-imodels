...
class HuberLinearRegressor(BaseEstimator, RegressorMixin):
...
HuberLinearRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "HuberLinear_v1"
model_description = "Robust Huber regression; clean linear formula output"
model_defs = [(model_shorthand_name, HuberLinearRegressor())]
