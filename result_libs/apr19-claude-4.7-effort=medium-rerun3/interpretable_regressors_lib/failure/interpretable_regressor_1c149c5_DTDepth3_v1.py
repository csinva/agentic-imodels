...
class DTDepth3Regressor(BaseEstimator, RegressorMixin):
...
DTDepth3Regressor.__module__ = "interpretable_regressor"

model_shorthand_name = "DTDepth3_v1"
model_description = "Plain depth-3 decision tree, min_samples_leaf=8"
model_defs = [(model_shorthand_name, DTDepth3Regressor())]
