...
class SqrtScaleOLSRegressor(BaseEstimator, RegressorMixin):
...
SqrtScaleOLSRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "SqrtScaleOLS_v1"
model_description = "OLS on sign*sqrt(|x|)-transformed features; tames outliers"
model_defs = [(model_shorthand_name, SqrtScaleOLSRegressor())]
