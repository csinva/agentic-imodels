...
class OMPCleanRegressor(BaseEstimator, RegressorMixin):
...
OMPCleanRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "OMPClean_v1"
model_description = "OrthogonalMatchingPursuit CV; clean linear formula in original scale"
model_defs = [(model_shorthand_name, OMPCleanRegressor())]
