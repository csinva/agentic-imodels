...
class ClusteredOLSRegressor(BaseEstimator, RegressorMixin):
...
ClusteredOLSRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "ClusteredOLS_v1"
model_description = "OLS after clustering correlated features (|corr|>0.9), keep 1 per cluster"
model_defs = [(model_shorthand_name, ClusteredOLSRegressor())]
