...
class BoostedStumpsRegressor(BaseEstimator, RegressorMixin):
...
BoostedStumpsRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "BoostedStumps30_v1"
model_description = "Stagewise boosting of 30 depth-1 stumps (lr=0.1), additive per-feature output"
model_defs = [(model_shorthand_name, BoostedStumpsRegressor())]
