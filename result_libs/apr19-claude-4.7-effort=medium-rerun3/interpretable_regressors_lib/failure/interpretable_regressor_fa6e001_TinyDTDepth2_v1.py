...
TinyDTDepth2Regressor.__module__ = "interpretable_regressor"

model_shorthand_name = "TinyDTDepth2_v1"
model_description = "Depth-2 decision tree (4 leaves)"
model_defs = [(model_shorthand_name, TinyDTDepth2Regressor())]
