...
class CenteredOLSRegressor(BaseEstimator, RegressorMixin):
...
CenteredOLSRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "CenteredOLS_v1"
model_description = "Plain centered OLS; clean y = intercept + sum c_i*x_i output"
model_defs = [(model_shorthand_name, CenteredOLSRegressor())]
