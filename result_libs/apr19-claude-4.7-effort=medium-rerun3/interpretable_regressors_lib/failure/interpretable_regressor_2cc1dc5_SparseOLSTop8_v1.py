...
class SparseOLSTop8Regressor(BaseEstimator, RegressorMixin):
    """LassoCV selects top-8, OLS refit on original scale."""
    ...
    def __str__(self):
        ...
        lines = [
            f"SparseOLSTop8 (LassoCV selects ≤{self.max_features} features, OLS refit):",
...
SparseOLSTop8Regressor.__module__ = "interpretable_regressor"

model_shorthand_name = "SparseOLSTop8_v1"
model_description = "LassoCV selects top-8 features, OLS refit in original scale"
model_defs = [(model_shorthand_name, SparseOLSTop8Regressor())]
