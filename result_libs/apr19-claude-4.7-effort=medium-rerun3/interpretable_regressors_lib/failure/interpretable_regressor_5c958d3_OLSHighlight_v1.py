...
class OLSHighlightRegressor(BaseEstimator, RegressorMixin):
...
OLSHighlightRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "OLSHighlight_v1"
model_description = "Plain OLS with coefficients sorted by |coef*std(x)| for clarity"
model_defs = [(model_shorthand_name, OLSHighlightRegressor())]
