...
class LassoOLSAllRegressor(BaseEstimator, RegressorMixin):
...
LassoOLSAllRegressor.__module__ = "interpretable_regressor"

model_shorthand_name = "LassoOLSAll_v1"
model_description = "LassoCV selects any nonzero features, OLS refit on full support"
model_defs = [(model_shorthand_name, LassoOLSAllRegressor())]
